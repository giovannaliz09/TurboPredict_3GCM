...
/* 🔥 HEADER */
.turbo-header { 
    background:linear-gradient(135deg,#0a0f1e,#0d1b35,#0a1628); 
...
# ── Tela de upload (SEM st.stop) ───────────────────────────────────────
if not data_files_ok():

    st.markdown("""
    <div style="background:linear-gradient(135deg,#0a0f1e,#0d1b35); 
                padding:20px; border-radius:12px; margin-bottom:20px;">
        <h2 style="color:#4fc3f7;">⚡ TurboPredict</h2>
        <p style="color:#8fadc8;">Configuração inicial — envie os dados</p>
    </div>
    """, unsafe_allow_html=True)

    st.info(
        "📂 Arquivos não encontrados.\n\n"
        "**Opção 1:** colocar CSV na pasta data/\n\n"
        "**Opção 2:** enviar abaixo"
    )
